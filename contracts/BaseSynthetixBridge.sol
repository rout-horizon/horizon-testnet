...
contract BaseSynthetixBridge is Owned, MixinSystemSettings, IBaseSynthetixBridge {
    ...
    function initiateSynthTransfer(
        ...
        require(getCrossChainSynthTransferEnabled(currencyKey) > 0, "Zasset not enabled for cross chain transfer");
        ...
        require(!rateInvalid, "Cannot initiate if zasset rate is invalid");
