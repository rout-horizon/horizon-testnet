...
contract ExchangeRatesWithDexPricing is ExchangeRates {
    ...
    function _getPriceFromDexAggregator(
        ...
        require(
            sourceSettings.currencyKey == zUSD || destinationSettings.currencyKey == zUSD,
            "Atomic swaps must go through zUSD"
        );
        ...
        return destinationSettings.currencyKey == "zUSD" ? result : SafeDecimalMath.unit().divideDecimalRound(result);
    }
